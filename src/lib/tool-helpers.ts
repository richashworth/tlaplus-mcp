/**
 * Shared helpers for tool response formatting and common patterns.
 */
...
/**
 * Derive a high-level status string from a parsed TLC result.
 */
...
/**
 * Format a successful tool response as JSON text content.
 */
